        ...
        <div className="card-dc">
          ...
          <div className="yellow-box-dc-container">
            <div className="yellow-box-dc">
              ...
              >
                <img src={facebook_logo} className="img-social-media-dc" />
              </button>
              <button
                className="button-dc"
                onClick={() => window.open(Instagram)}
              >
                <img src={instagram_logo} className="img-social-media-dc" />
              </button>
              <button
                className="button-dc"
                onClick={() => window.open(Linkedin)}
              >
                <img src={linkedin_logo} className="img-social-media-dc" />
              </button>
            </div>
          </div>
          ...
          <div className="column">
            <div className="image-box-dc">
              ...
              <img src={image?.url} className="depoiments-image" />
            </div>
