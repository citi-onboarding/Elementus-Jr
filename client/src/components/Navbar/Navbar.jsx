        ...
        <div>
            ...
            <ul id="lateralNavbarId" className="lateralNavbar">
                ...
                <div className="boxSidebarSocialNetwork">
                    <button onClick={()=> window.open(LinkSocialNetwork.linkInstagram)} className="buttonSidebarSocialNetwork"><img className="imgLogoSideBarSocialNetwork" src={instagram_logo} alt=""/></button>
                    <button onClick={()=> window.open(LinkSocialNetwork.linkFacebook)} className="buttonSidebarSocialNetwork"><img className="imgLogoSideBarSocialNetwork" src={facebook_logo} alt=""/></button>
                    <button onClick={()=> window.open(LinkSocialNetwork.linkLinkedin)} className="buttonSidebarSocialNetwork"><img className="imgLogoSideBarSocialNetwork" src={linkedin_logo} alt=""/></button>
                </div>
